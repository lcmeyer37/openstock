...
public class mpsubmodulografico extends javax.swing.JPanel
{
    ...
    {       
        //String entidadeatualstr = mcg.entityatualgrafico.toString();
        //String precomouseatualstr = String.format( "%.4f", mcg.valormouseatualgraficoy);
        //jlInfoExtraGrafico.setText("Preco: " + precomouseatualstr + " Entidade: " + entidadeatualstr);
    }
    ...
    private void initComponents()
    {
        ...
        jButtonAtivarSelecao.setText("S");
        ...
        jButtonEscolherSimbolo.setText("Procurar");
        ...
        jLabelNomeSimbolo.setText("Símbolo:");
        ...
        jLabelPeriodoSimbolo.setText("Período:");

        jComboBoxPeriodoSimbolo.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "1 minuto", "5 minutos", "15 minutos", "30 minutos", "60 minutos", "Dias", "Semanas", "Meses" }));

        jButtonCarregarConfiguracao.setText("Carregar Configuração");

        jButtonSalvarConfiguracao.setText("Salvar Configuração");

        jButtonAtualizarDadosGrafico.setText("Atualizar Dados do Gráfico");
        ...
        jButtonAdicionarIndicador.setText("Adicionar");
        ...
        jLabelAnotacoes.setText("Anotações");
