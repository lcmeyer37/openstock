 ...
 * @author meyerlu
 */
public class mfeditorbearcode extends javax.swing.JFrame 
{
    ...
    public mfeditorbearcode(mierstockfx.TelaPrincipal tppai) 
    {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(mfeditorbearcode.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new mfeditorbearcode(telappai).setVisible(true);
            }
        });
    }
