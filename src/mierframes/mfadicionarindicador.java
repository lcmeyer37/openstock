  ...
  public static void main(String argv[]) {
    ...
    */
    ...
    private void initComponents()
    {
        ...
        setTitle("Adicionar Novo Indicador");

        jLabelNome.setText("Nome:");

        jComboBoxIndicadoresDisponiveis.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "(sem indicadores)" }));

        jLabelParametros.setText("Paramêtros:");
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addComponent(jComboBoxIndicadoresDisponiveis, 0, 341, Short.MAX_VALUE))
                    .addGroup(layout.createSequentialGroup()
