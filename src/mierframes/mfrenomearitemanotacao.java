 ...
 * @author lucasmeyer
 */
public class mfrenomearitemanotacao extends javax.swing.JFrame
{
    public static mierpanels.mpitemanotacao mpitemanotacao;
    
    /**
     * Creates new form mfrenomearitemgrafico
     */
    public mfrenomearitemanotacao(mierpanels.mpitemanotacao mpia)
    {
        initComponents();
    ...
    public static void main(String args[])
    {
        ...
        {
            java.util.logging.Logger.getLogger(mfrenomearitemanotacao.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable()
        {
            public void run()
            {
                new mfrenomearitemanotacao(mpitemanotacao).setVisible(true);
            }
        });
    }
