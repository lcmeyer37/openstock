 ...
 */
package frames.analisadorasset;

/**
 *
 * @author meyerlu
 */
public class shjanelaseparada extends javax.swing.JFrame
{
    //classe frame utilizada para segurar o submodulosholder em uma janela separada
    static panels.analisadorasset.analisadorasset aassetpai;

    /**
     * Creates new form analisadorassetjanelaholder
     */
    public shjanelaseparada(panels.analisadorasset.analisadorasset aapai)
    {
        initComponents();
            ...
            void main(String args[])
    {
        ...
        {
            java.util.logging.Logger.getLogger(shjanelaseparada.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        ...
        java.awt.EventQueue.invokeLater(new Runnable()
        {
            public void run()
            {
                new shjanelaseparada(aassetpai).setVisible(true);
            }
        });
    }
