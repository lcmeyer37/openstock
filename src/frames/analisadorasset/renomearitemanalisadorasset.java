 ...
 * @author lucasmeyer
 */
public class renomearitemanalisadorasset extends javax.swing.JFrame
{
    public static panels.analisadorasset.itemanalisadorasset mpitemgrafico;
    
    /**
     * Creates new form mfrenomearitemgrafico
     */
    public renomearitemanalisadorasset(panels.analisadorasset.itemanalisadorasset mpig)
    {
        initComponents();
    ...
    public static void main(String args[])
    {
        ...
        {
            java.util.logging.Logger.getLogger(renomearitemanalisadorasset.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable()
        {
            public void run()
            {
                new renomearitemanalisadorasset(mpitemgrafico).setVisible(true);
            }
        });
    }
