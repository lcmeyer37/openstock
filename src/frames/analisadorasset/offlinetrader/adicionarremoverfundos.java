 ...
 */
package frames.analisadorasset.offlinetrader;

/**
 *
 * @author meyerlu
 */
public class adicionarremoverfundos extends javax.swing.JFrame
{
    public static panels.analisadorasset.offlinetrader.submoduloofflinetrader submoduloofftraderpai;

    /**
     * Creates new form adicionarremoverfundos
     */
    public adicionarremoverfundos(panels.analisadorasset.offlinetrader.submoduloofflinetrader sotp)
    {
        initComponents();
            ...
            void main(String args[])
    {
        ...
        {
            java.util.logging.Logger.getLogger(adicionarremoverfundos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        ...
        java.awt.EventQueue.invokeLater(new Runnable()
        {
            public void run()
            {
                new adicionarremoverfundos(submoduloofftraderpai).setVisible(true);
            }
        });
    }
