 ...
 * @author lucasmeyer
 */
public class chartseparado extends javax.swing.JFrame
{

    /**
     * Creates new form mfchartseparado
     */
    public chartseparado()
    {
        initComponents();
    }
    ...
    private void initComponents()
    {
        ...
        jPanelChartpanelholder.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
    ...
    public static void main(String args[])
    {
        ...
        {
            java.util.logging.Logger.getLogger(chartseparado.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable()
        {
            public void run()
            {
                new chartseparado().setVisible(true);
            }
        });
    }
