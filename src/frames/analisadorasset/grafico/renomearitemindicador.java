 ...
 * @author lucasmeyer
 */
public class renomearitemindicador extends javax.swing.JFrame
{
    public static panels.analisadorasset.grafico.itemindicador mpitemindicador;
    
    /**
     * Creates new form mfrenomearitemgrafico
     */
    public renomearitemindicador(panels.analisadorasset.grafico.itemindicador mpii)
    {
        initComponents();
    ...
    private void initComponents()
    {
        ...
        jPanelFundo2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanelFundo2Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(jTextFieldNovoNomeItemIndicador, javax.swing.GroupLayout.DEFAULT_SIZE, 257, Short.MAX_VALUE)
                .addGap(63, 63, 63))
    ...
    public static void main(String args[])
    {
        ...
        {
            java.util.logging.Logger.getLogger(renomearitemindicador.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable()
        {
            public void run()
            {
                new renomearitemindicador(mpitemindicador).setVisible(true);
            }
        });
    }
