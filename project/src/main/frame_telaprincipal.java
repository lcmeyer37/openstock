...
public class frame_telaprincipal extends javax.swing.JFrame 
{
    ...
    void adicionarNovoAnalisadorAsset()
    {
        ...
        selecionarItemAnalisadorAsset((analisadorasset.panel_itemanalisadorasset)jPanelItensAnalisadorAsset.getComponent(novonumeroassets-1));      
    ...
    public void removerAnalisadorAsset(analisadorasset.panel_itemanalisadorasset mpiadeletar)
    {
        ...
        if (numeroassetsatual > 0)
            selecionarItemAnalisadorAsset((analisadorasset.panel_itemanalisadorasset)jPanelItensAnalisadorAsset.getComponent(numeroassetsatual-1));
        else
            jPanelHolderAnalisadorAsset.add(nam);
    ...
    public void selecionarItemAnalisadorAsset(analisadorasset.panel_itemanalisadorasset mpigselecionar)
    {
        ...
        {
            analisadorasset.panel_itemanalisadorasset mpigatual = (analisadorasset.panel_itemanalisadorasset) jPanelItensAnalisadorAsset.getComponent(i);
    ...
    private void initComponents()
    {
        ...
        jButtonJanelaConfiguracoes.setText("More");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frame_telaprincipal.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frame_telaprincipal().setVisible(true);
            }
        });
    }
