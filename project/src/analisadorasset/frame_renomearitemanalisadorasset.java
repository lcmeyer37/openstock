 ...
 * @author lucasmeyer
 */
public class frame_renomearitemanalisadorasset extends javax.swing.JFrame
{
    public static analisadorasset.panel_itemanalisadorasset mpitemgrafico;
    
    /**
     * Creates new form mfrenomearitemgrafico
     */
    public frame_renomearitemanalisadorasset(analisadorasset.panel_itemanalisadorasset mpig)
    {
        initComponents();
        
        mpitemgrafico = mpig;
        jTextFieldNovoNomeItemGrafico.setText(mpitemgrafico.jLabelNomeAnalisadorAsset.getText());
    }
    ...
    public static void main(String args[])
    {
        ...
        {
            java.util.logging.Logger.getLogger(frame_renomearitemanalisadorasset.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable()
        {
            public void run()
            {
                new frame_renomearitemanalisadorasset(mpitemgrafico).setVisible(true);
            }
        });
    }
