...
import static analisadorasset.submodulografico.frame_adicionarindicador.submodulopai;
import java.io.File;
 ...
 * @author lucasmeyer
 */
public class panel_submoduloofflinetrader extends javax.swing.JPanel
{
     /*
    ...
    */
    ...
    public panel_submoduloofflinetrader(analisadorasset.panel_submodulosholder shpai)
    {
        initComponents();
    ...
    void inicializarsubmoduloofflinetrader()
    {
        ...
        {
            jPanelLinhasTransacoes.add(new analisadorasset.submoduloofflinetrader.panel_itemtransacao(otrader.transacoes.get(i)));
        }
    ...
    {//GEN-HEADEREND:event_jButtonAlterarFundosActionPerformed
        analisadorasset.submoduloofflinetrader.frame_adicionarremoverfundos mfarf = new analisadorasset.submoduloofflinetrader.frame_adicionarremoverfundos(this);
        mfarf.show();
