 ...
 * @author lucasmeyer
 */
public class panel_submodulografico extends javax.swing.JPanel
{
    /*
    ...
    */
    ...
    public analisadorasset.panel_submodulosholder submodulohpai; 
    //classe utilizada para desenhar graficos
    public mierclasses.mcchartgenerator mcg; 
    // </editor-fold>
    
    // <editor-fold defaultstate="collapsed" desc="CONSTRUTOR">
    public panel_submodulografico(analisadorasset.panel_submodulosholder shpai)
    {
        initComponents();
    ...
    public void recarregardadossubmodulografico(boolean resetaranotacoesindicadores)
    {
        ...
        else if (resetaranotacoesindicadores == false)
        {
            ...
            {
                analisadorasset.submodulografico.panel_itemindicador novoindicador = (analisadorasset.submodulografico.panel_itemindicador)jPanelIndicadores.getComponent(i);
            ...
            for (int i = 0; i < jPanelIndicadores.getComponentCount(); i++)
            {
                    analisadorasset.submodulografico.panel_itemindicador miia = (analisadorasset.submodulografico.panel_itemindicador)jPanelIndicadores.getComponent(i);
            ...
            {
                analisadorasset.submodulografico.panel_itemanotacao novoanotacao = (analisadorasset.submodulografico.panel_itemanotacao)jPanelAnotacoes.getComponent(i);
    ...
    public void adicionarIndicadorNovo(String idbc, String paramsbc)
    {
        ...
        analisadorasset.submodulografico.panel_itemindicador novoindicador = new analisadorasset.submodulografico.panel_itemindicador(this, idbc, paramsbc);
    ...
    {
        analisadorasset.submodulografico.panel_itemindicador novoindicador = new analisadorasset.submodulografico.panel_itemindicador(this, id, nome, idbc, paramsbc);
        String statusrunindicador = novoindicador.rodarscriptindicador();
        if (statusrunindicador.equals("ok"))
        {
            if (novoindicador.mcbcindicador.tipoplot_lastrun.equals("drawoncandles"))
    ...
    public void removerIndicador(analisadorasset.submodulografico.panel_itemindicador mpiiremover)
    {
    ...
    public void setarGraficoIndicadorSecundario(analisadorasset.submodulografico.panel_itemindicador mpiidestacarabaixo)
    {
        for (int i = 0; i < jPanelIndicadores.getComponentCount(); i++)
        {
            analisadorasset.submodulografico.panel_itemindicador miia = (analisadorasset.submodulografico.panel_itemindicador)jPanelIndicadores.getComponent(i);
    ...
    void adicionarAnotacaoNovo()
    {
        ...
        if (quantidade_xyannotations_ohlc > quantidadeids_listacontroleanotacao)
        {
            ...
            analisadorasset.submodulografico.panel_itemanotacao novompia = new analisadorasset.submodulografico.panel_itemanotacao(this,mcg.anotacaoselecionada,mcg.anotacao_emhold);
    ...
    public void adicionarAnotacaoLoad(String nome, String id, String tipo, java.util.List<org.jfree.chart.annotations.XYAnnotation> anotacao)
    {
        ...
        analisadorasset.submodulografico.panel_itemanotacao novompia = new analisadorasset.submodulografico.panel_itemanotacao(this, nome, id, tipo, anotacao);
    ...
    public void removerAnotacao(analisadorasset.submodulografico.panel_itemanotacao mpiaremover)
    {
    ...
    void exportarcsvdados()
    {
         ...
         try
        {
            ...
            {
                analisadorasset.submodulografico.panel_itemindicador indicadoratual = (analisadorasset.submodulografico.panel_itemindicador)jPanelIndicadores.getComponent(j);
    ...
    {//GEN-HEADEREND:event_jButtonAdicionarIndicadorActionPerformed
        analisadorasset.submodulografico.frame_adicionarindicador mfai = new analisadorasset.submodulografico.frame_adicionarindicador(this);
        mfai.show();
    ...
    {//GEN-HEADEREND:event_jButtonEscolherSimboloActionPerformed
        analisadorasset.submodulografico.frame_adicionarsimbolo as = new analisadorasset.submodulografico.frame_adicionarsimbolo(this,jTextFieldNomeSimbolo.getText());
        as.show();    
