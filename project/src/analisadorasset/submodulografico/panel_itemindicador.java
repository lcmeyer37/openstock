 ...
 * @author lucasmeyer
 */
public class panel_itemindicador extends javax.swing.JPanel
{
    ...
    public analisadorasset.submodulografico.frame_chartseparado mfcs;
    ...
    public panel_itemindicador(analisadorasset.submodulografico.panel_submodulografico mpsmg, String idbearcode, String parametrosbearcode)
    {
        initComponents();
    ...
    public panel_itemindicador(analisadorasset.submodulografico.panel_submodulografico mpsmg, String idind, String nome, String idbearcode, String parametrosbearcode)
    {
        initComponents();
    ...
    public void criargraficoseparadoindicador()
    {
        ...
        mfcs = new analisadorasset.submodulografico.frame_chartseparado();
    ...
    {//GEN-HEADEREND:event_jLabelAbrirJanelaRenomearItemIndicadorMouseClicked
        analisadorasset.submodulografico.frame_renomearitemindicador mfrii = new analisadorasset.submodulografico.frame_renomearitemindicador(this);
        mfrii.show();
