 ...
 * @author meyerlu
 */
public class panel_submodulosholder extends javax.swing.JPanel
{
    /*
    ...
    */
    ...
    public analisadorasset.panel_analisadorasset assetpai;
    //submobulo grafico
    public analisadorasset.submodulografico.panel_submodulografico subgrafico;
    //submodulo trader
    public analisadorasset.submoduloofflinetrader.panel_submoduloofflinetrader subtrader;
    //recebe o simbolo deste asset
    public String assetsimbolo;
    //</editor-fold>
 
    // <editor-fold defaultstate="collapsed" desc="CONSTRUTOR">
    public panel_submodulosholder(analisadorasset.panel_analisadorasset aapai)
    {
        initComponents();
    ...
    void inicializar(analisadorasset.panel_analisadorasset aapai)
    {
        ...
        subgrafico = new analisadorasset.submodulografico.panel_submodulografico(this);
        subtrader = new analisadorasset.submoduloofflinetrader.panel_submoduloofflinetrader(this);
    ...
    public void mostrarsubmodulografico()
    {
    ...
    public void mostrarsubmodulotrader()
    {
        jPanelSubmodulosHolder.removeAll();
    ...
    public void salvardadosasset()
    {
        ...
        try
        {
            ...
            {
                analisadorasset.submodulografico.panel_itemindicador miia = (analisadorasset.submodulografico.panel_itemindicador)subgrafico.jPanelIndicadores.getComponent(i);
            ...
            {
                analisadorasset.submodulografico.panel_itemanotacao miaa = (analisadorasset.submodulografico.panel_itemanotacao)subgrafico.jPanelAnotacoes.getComponent(i);
            ...
            String xmlSave = 
                "<?xml version=\"1.0\"?>" +
                    "<OpenstockAssetSave>" +
                        ...
                        "<About>" +
                            "<Name>" + subgrafico.submodulohpai.assetpai.iaassetpai.jLabelNomeAnalisadorAsset.getText() + "</Name>" +
                            "<ID>" + subgrafico.submodulohpai.assetpai.iaassetpai.id + "</ID>" +
                        "</About>" +
    ...
    public void carregardadosasset()
    {
        try
        {
            ...
            if (userSelection == javax.swing.JFileChooser.APPROVE_OPTION) 
            {
                ...
                assetpai.iaassetpai.renomearitem(assetsimbolo);
                ...
                assetpai.iaassetpai.jLabelNomeAnalisadorAsset.setText(nomeasset);
                assetpai.iaassetpai.id = idasset;
    ...
    void colocaremjanelasuspensa()
    {
        //funcao para colocar este submodulosholder em uma janela suspensa
    }
    ...
    private void initComponents()
    {
        ...
        jLabelDetachSubmodulosholder = new javax.swing.JLabel();
        ...
        jLabelDetachSubmodulosholder.setForeground(new java.awt.Color(255, 255, 125));
        jLabelDetachSubmodulosholder.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabelDetachSubmodulosholder.setIcon(new javax.swing.ImageIcon(getClass().getResource("/assets/detachicon.png"))); // NOI18N
        jLabelDetachSubmodulosholder.addMouseListener(new java.awt.event.MouseAdapter()
        {
            public void mouseClicked(java.awt.event.MouseEvent evt)
            {
                jLabelDetachSubmodulosholderMouseClicked(evt);
            }
        });
            ...
            .addGroup(jPanelEscolherSubmoduloLayout.createSequentialGroup()
                ...
                .addGroup(jPanelEscolherSubmoduloLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanelEscolherSubmoduloLayout.createSequentialGroup()
                        ...
                        .addComponent(jLabelDetachSubmodulosholder))
    ...
    private void jLabelDetachSubmodulosholderMouseClicked(java.awt.event.MouseEvent evt)//GEN-FIRST:event_jLabelDetachSubmodulosholderMouseClicked
    {//GEN-HEADEREND:event_jLabelDetachSubmodulosholderMouseClicked
        assetpai.detachsubmodulosholder();
    }//GEN-LAST:event_jLabelDetachSubmodulosholderMouseClicked
    ...
    public javax.swing.JLabel jLabelDetachSubmodulosholder;
